...
CREATE TABLE `borrowing_records` (
  ...
  KEY `book_id` (`book_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `borrowing_records_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `book_table` (`book_id`),
  CONSTRAINT `borrowing_records_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `table_user` (`user_id`)
...
-- Dump completed on 2025-05-24 23:53:17
